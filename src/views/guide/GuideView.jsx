  ...
  return (
    <div>
      <div className="container-guide">
        <div>
          ...
          <div className="box-bases">
            ...
            <p className="font-paragraphBases">
              ...
              casillas de respuesta que figurarán debajo del título o pregunta.
              Debes pulsar el que creas que es la opción correcta,. Si pulsas en
              el correcto se te sumará un punto en tu cuenta final y saltará a
              la siguiente pregunta, si no, saltará a la siguiente pregunta sin
              sumar puntos.
            </p>
          </div>
          <div className="d-flex">
            ...
            <div className="box-intermediate">
              ...
              <p className="font-paragraph">
                ...
                pulsarlos en relación a la pregunta sugerida, pero aquí, en
                lugar de decir que es, te pregunta por lo que puede ser.
              </p>
            </div>
          </div>
          {/* -----------------------------------------------------------------------------AVANZADO----------------------- */}
        ...
        <img src={letterLogo} alt="" style={{ width: "30%", padding: 20 }} />
      </div>
    </div>
  );
}
